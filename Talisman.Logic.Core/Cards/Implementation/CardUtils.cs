...
public static class CardUtils
{
    ...
    public static void SetCardOwner(GameData gameData, IPickableCard card, IPlayer player)
    {
    ...
    public static void BurnCard(GameData gameData, ICard card, IDeck burntCardsDeck)
    {
        if (card == null) throw new ArgumentNullException(nameof(card));
