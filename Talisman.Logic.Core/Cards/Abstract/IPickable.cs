...
public interface IPickableCard : ICard
{
    ...
    IEnumerable<IEvent> GetPickupEvents(GameData gameData, IPlayer player);
    ...
    IEnumerable<IEvent> GetDropEvents(GameData gameData, IPlayer player);
    ...
    bool CanBePickedUpByPlayer(GameData gameData, IPlayer player);
    ...
    bool CanBeDroppedByPlayer(GameData gameData, IPlayer player);
}